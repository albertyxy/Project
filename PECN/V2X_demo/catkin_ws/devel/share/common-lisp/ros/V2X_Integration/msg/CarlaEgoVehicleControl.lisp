...
(cl:defmethod cl:initialize-instance :after ((m <CarlaEgoVehicleControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarlaEgoVehicleControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name V2X_Integration-msg:<CarlaEgoVehicleControl> is deprecated: use V2X_Integration-msg:CarlaEgoVehicleControl instead.")))
...
(cl:defmethod throttle-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_Integration-msg:throttle-val is deprecated.  Use V2X_Integration-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_Integration-msg:steer-val is deprecated.  Use V2X_Integration-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_Integration-msg:brake-val is deprecated.  Use V2X_Integration-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'hand_brake-val :lambda-list '(m))
(cl:defmethod hand_brake-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_Integration-msg:hand_brake-val is deprecated.  Use V2X_Integration-msg:hand_brake instead.")
  (hand_brake m))

(cl:ensure-generic-function 'reverse-val :lambda-list '(m))
(cl:defmethod reverse-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_Integration-msg:reverse-val is deprecated.  Use V2X_Integration-msg:reverse instead.")
  (reverse m))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_Integration-msg:gear-val is deprecated.  Use V2X_Integration-msg:gear instead.")
  (gear m))
...
(cl:defmethod manual_gear_shift-val ((m <CarlaEgoVehicleControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader V2X_Integration-msg:manual_gear_shift-val is deprecated.  Use V2X_Integration-msg:manual_gear_shift instead.")
  (manual_gear_shift m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CarlaEgoVehicleControl>)))
  ...
  "V2X_Integration/CarlaEgoVehicleControl")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CarlaEgoVehicleControl)))
  "Returns string type for a message object of type 'CarlaEgoVehicleControl"
  "V2X_Integration/CarlaEgoVehicleControl")
