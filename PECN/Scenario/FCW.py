...
class Forward_Car_Warning(BasicScenario):

    """
    This class holds everything required for a simple "Forward_Car_Warning"
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        #self.target_location = carla.Location(203.4, -62.3, 0)

        # Timeout of scenario in seconds
        self.timeout = timeout

        super(Forward_Car_Warning, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
    ...
    def _create_behavior(self):
        ...
        start_transform = ActorTransformSetter(self.other_actors[0], self._first_actor_transform)
        ...
        just_drive.add_child(WaypointFollower(self.other_actors[0], self._first_vehicle_speed))
        just_drive.add_child(InTriggerDistanceToLocation(
